...
public class UpdatePermissionsPayload extends Payload implements Serializable {
    private final String fileName;
    private final String parent;
    private final Map<String, String> accessList;

    public UpdatePermissionsPayload(Builder builder) {
        super();
    ...
    public static class Builder {
        ...
        public UpdatePermissionsPayload build() {
            return new UpdatePermissionsPayload(this);
        }
    }
}
